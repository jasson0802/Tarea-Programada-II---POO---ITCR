/*
 * Created by JFormDesigner on Mon May 20 21:40:02 CST 2013
 */
 ...
 */
public class FormularioPeriodismo extends JFrame {
	public FormularioPeriodismo() {
		initComponents();
	...
	private void botonCrearMouseClicked(MouseEvent e) {
		...
		rutaSonido = entradaSonido.getText();
		
		
		try{
			ALFE.gestorFotos.agregarFotografia(rutaImagen, pais, descripcion, dia, mes, anio,
           Integer.parseInt(base), Integer.parseInt(altura),formato, Double.parseDouble(tamano), 
           evento, hora, ambito, rutaSonido, 
           longitud, latitud);
			this.dispose();
		}
		catch(Exception p){
							...
							.addGroup(GroupLayout.Alignment.LEADING, panel1Layout.createSequentialGroup()
								...
								.addGroup(panel1Layout.createParallelGroup()
									...
									.addGroup(panel1Layout.createSequentialGroup()
										...
										.addComponent(label9)
										.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(entradaFormato, GroupLayout.PREFERRED_SIZE, 52, GroupLayout.PREFERRED_SIZE)))))
