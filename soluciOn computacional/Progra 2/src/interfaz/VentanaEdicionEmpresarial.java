/*
 * Created by JFormDesigner on Tue May 21 11:04:31 CST 2013
 */
 ...
 */
public class VentanaEdicionEmpresarial extends JFrame {
	public VentanaEdicionEmpresarial(Empresarial miFoto) {
		initComponents();
		
		
		foto = miFoto;
		entradaImagen.setText(foto.getNombreArchivo());
		entradaTwitter.setText(foto.getCuentaTwitter());
		entradaFacebook.setText(foto.getCuentaFacebook());
		entradaQR.setText(foto.getCodigoQR());
		entradaCompania.setText(foto.getNombreCompania());
		entradaDia.setText(foto.getFechaCreacion());
		entradaDescripcion.setText(foto.getDescripcion());
		//entradaAnio.setText();
		
		entradaTamanio.setText(String.valueOf(foto.getTamanoArchivo()));
	...
	private void botonAgregarImgMouseClicked(MouseEvent e) {
		...
		imagen2 = new ImageIcon(rutaImagen).getImage();
		
		entradaBase.setText(String.valueOf(imagen2.getHeight(null)));
		entradaAltura.setText(String.valueOf(imagen2.getWidth(null)));
	...
	private void botonCrearMouseClicked(MouseEvent e) {
		...
		ALFE.gestorFotos.modificarFotografia(foto.getId(), rutaImagen, pais, descripcion, dia, mes, anio, Integer.parseInt(base), Integer.parseInt(altura),
				formato, Double.parseDouble(tamano), compania, facebook, twitter, rutaQR);
		}catch(Exception o){
					...
					.addGroup(panel1Layout.createSequentialGroup()
						...
						.addGroup(panel1Layout.createParallelGroup()
							...
							.addGroup(panel1Layout.createSequentialGroup()
								.addComponent(label7)
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(entradaBase, GroupLayout.PREFERRED_SIZE, 66, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(entradaAltura, GroupLayout.PREFERRED_SIZE, 42, GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(label8)
								.addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(entradaFormato, GroupLayout.PREFERRED_SIZE, 71, GroupLayout.PREFERRED_SIZE))
							.addGroup(panel1Layout.createSequentialGroup()
